...
const products = [
  {
    title: "Solar Terrassenüberdachung aus Aluminium",
    description: "schützt zuverlässig vor Witterungseinflüssen und senkt gleichzeitig Ihre Energiekosten.",
    image: img,
   link: "/solarTerrassenüberdachung",
  }
];
...
export default function SolarTerrassenüberdachungen() {
  return (
    <div className="ueberdachungen-page">
      <header className="header1">
        <h1>Solar Terrassenüberdachungen</h1>
  ...
  <p>
    Solar-Überdachungen von Wintergartenmeister verbinden modernen Wetterschutz mit nachhaltiger Energiegewinnung.
    So nutzen Sie Ihre Terrasse nicht nur zum Wohlfühlen, sondern auch zur Stromerzeugung.
  </p>
  ...
  <p>
    Entdecken Sie unsere Solar-Überdachungen für Terrasse und Carport –
    für mehr Unabhängigkeit, Komfort und eine moderne Energiezukunft.
  </p>
</section>
