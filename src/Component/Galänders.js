...
const products = [
  {
    title: "Geländer aus Aluminium & Glas ",
    description: "modern, stabil und  wartungsfrei.",
    image: img,
   link: "/galänder",
  }
];
...
export default function Galänders() {
  return (
  ...
  <p>
    Geländer von Wintergartenmeister verbinden Sicherheit mit modernem Design und passen sich harmonisch an Ihr Zuhause an.
    Sie bieten zuverlässigen Schutz und setzen gleichzeitig stilvolle Akzente im Außenbereich.
  </p>
  ...
  <p>
    Entdecken Sie unsere Geländer-Lösungen für Balkon, Terrasse und Treppe –
    für mehr Sicherheit und eine moderne Optik.
  </p>
</section>
