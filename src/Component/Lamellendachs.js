...
const products = [
  {
    title: "Lamellendach aus Aluminium ",
    description: "höchsten Komfort für Ihre Terrasse.",
    image: img,
   link: "/lamellendach",
  }
];
...
export default function Lamellendachs() {
  return (
    <div className="ueberdachungen-page">
      <header className="header1">
        <h1>Lamellendächte</h1>
  ...
  <p>
    Lamellendächer von Wintergartenmeister bieten Ihnen flexiblen Sonnen- und Wetterschutz für Ihren Außenbereich.
    Dank verstellbarer Lamellen genießen Sie jederzeit das perfekte Klima – offen, geschlossen oder dazwischen.
  </p>
  ...
  <p>
    Entdecken Sie unsere Lamellendach-Lösungen für Terrasse und Garten –
    für mehr Komfort, Flexibilität und modernes Outdoor-Wohnen.
  </p>
</section>
